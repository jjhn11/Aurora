...
-- Insertar datos en Countries_
INSERT INTO Countries_ (Country_name) VALUES 
('México'), ('Estados Unidos'), ('España'), ('Argentina'), ('Colombia');

-- Insertar datos en Careers_
INSERT INTO Careers_ (Career_name) VALUES 
...
-- Insertar datos en User_status_
INSERT INTO User_status_ (User_status) VALUES 
('Activo'), ('Inactivo'), ('Suspendido'), ('Graduado'), ('Baja temporal');

-- Insertar datos en Genders_
INSERT INTO Genders_ (Gender_name) VALUES 
('Masculino'), ('Femenino'), ('No binario'), ('Prefiero no decir');

-- Insertar datos en Community_event_attendance_
INSERT INTO Community_event_attendance_ (Attendance_name) VALUES 
('Asistió'), ('No asistió'), ('Justificado'), ('Tardanza'), ('Canceló');

-- Insertar datos en Users_ (asegurando que los foreign keys existan)
INSERT INTO Users_ (Id_user, Id_career, Control_num, Name_user, Last_name, Email, Id_gender, Password, Id_country, Id_user_status, Id_attendance_co) VALUES 
('USER001', 1, '19210001', 'Juan', 'Pérez González', 'juan.perez@itmexicali.edu.mx', 1, 'password123', 1, 1, 1),
('USER002', 2, '19210002', 'María', 'López Sánchez', 'maria.lopez@itmexicali.edu.mx', 2, 'password123', 1, 1, 2),
('USER003', 3, '19210003', 'Carlos', 'Ramírez Vega', 'carlos.ramirez@itmexicali.edu.mx', 1, 'password123', 1, 1, 1),
('USER004', 4, '19210004', 'Ana', 'Martínez Cruz', 'ana.martinez@itmexicali.edu.mx', 2, 'password123', 1, 1, 3),
('USER005', 5, '19210005', 'Roberto', 'González Torres', 'roberto.gonzalez@itmexicali.edu.mx', 1, 'password123', 1, 1, 1);

-- Insertar datos en Event_categories_
INSERT INTO Event_categories_ (Event_name) VALUES 
('Académico'), ('Cultural'), ('Deportivo'), ('Social'), ('Tecnológico');

-- Insertar datos en Event_types_
...
-- Insertar datos en Calendar_Events_
...
-- Insertar datos en Event_Attendance_
...
-- Insertar datos en Community_activities_
...
-- Insertar datos en Community_activity_attendance_
...
-- Crear tabla temporal para demos si es necesario
...
-- Insertar datos de ejemplo en la tabla tasks
